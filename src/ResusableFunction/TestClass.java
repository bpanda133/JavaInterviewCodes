...
public class TestClass {
	...
	public static int Exceldata(String DataFilePath,String ColumnName,String DataSheetName,int callcount, String TestCaseName,int datacounter) throws IOException
	{
		String Key = "";
		String Value= "";
		String tcid = "";
